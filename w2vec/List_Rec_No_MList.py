...
predictors = ['Concreteness', 'Word Frequency', 'Word Length',  'Pool Meaningfulness', "Trial No",
              "Session No", ]
...
labels = ['','Concreteness', 'Frequency', 'Length', 'M Pool', 'Trial No', 'Session No']
...
plt.savefig("List_Recall_No_Mlist_Dec31.pdf")
plt.show()
