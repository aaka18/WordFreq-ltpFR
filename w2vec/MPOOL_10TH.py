...
# print("Length of it should be 576:", len(w2v_ltpFR2))
#
# # Find the 90th percentile of the values
# ltpFR2_90 = np.percentile(w2v_ltpFR2, 90)
# print("90th percentile value:", ltpFR2_90)
#
# larger_90_all_wordpool = []
# for i in range(len(w2v_corr)):
#     #print(i)
#     #print(w2v_corr[i])
#     if w2v_corr[i] >= ltpFR2_90:
#         larger_90_all_wordpool.append(i+1)
# print("All of the word pool indices (in all word pool) from the W2v correlations that are larger than 90th percentile value:", larger_90_all_wordpool)
# print(" Number of words from all word pool that are larger than 90th percentile:", len(larger_90_all_wordpool))
#
# # Find the 90th percentile ltpFR2 word pool items' indices in all word pool
# ltpFR2_90_index = []
# # Check all of the indices that have greater than 90th percentile similarity in all word pool
# for i in larger_90_all_wordpool:
#     # If that index is an index of ltpFR2 as well, append it to ltpFR2_90_index
#     if i in ltpFR2_index:
#         ltpFR2_90_index.append(i)
# print("All of the ltpFR2 word pool indices (in all word pool) from the W2v correlations that are larger than 90th percentile value:", ltpFR2_90_index)
# print("Number of ltpFR2 words that are larger than 90th percentile value:",len(ltpFR2_90_index))
#
# # As a sanity check, finding the word to all other word similarities that are in 90th percentile from ltpFR2.
# w2v_corr_larger_90_ltpFR2 = []
# for index in ltpFR2_90_index:
#     w2v_corr_larger_90_ltpFR2.append(w2v_corr[index-1])
# print("W2V correlations of 90th percentile ltpFR2 words:", w2v_corr_larger_90_ltpFR2)
# print("Its length should be 58:", len(w2v_corr_larger_90_ltpFR2))
#
#
...
if __name__ == "__main__":
    # Get file path
    files_ltpFR2 = glob.glob('/Users/adaaka/rhino_mount/data/eeg/scalp/ltp/ltpFR2/behavioral/data/stat_data_LTP33*.mat')
