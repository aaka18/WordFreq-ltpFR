...
# Final Code For Word Recall Without MPool
...
sem_betas = [round(stats.sem(beta_concreteness), 3), round(stats.sem(beta_wordfreq), 3),
             ...
             round(stats.sem(beta_imag), 3), round(stats.sem(beta_mlist), 3)]

predictors = ['Concreteness', 'Word Frequency', 'Word Length', 'Valence',
              'Arousal', 'Imageability', 'List Meaningfulness' ]
...
plt.savefig("Final_Word_Recall_NoMPoolJan8_.pdf")
plt.show()
