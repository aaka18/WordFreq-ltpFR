...
m_list_larger_90_yes_or_no = []
for i in ltpFR2_index:
    if i in m_list_larger_90:
        m_list_larger_90_yes_or_no.append(1)
    else:
        m_list_larger_90_yes_or_no.append(0)
print(m_list_larger_90_yes_or_no)
