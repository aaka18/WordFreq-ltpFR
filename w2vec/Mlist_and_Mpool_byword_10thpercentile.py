...
for value in w2v_ltpFR2:
    if value >= ltpFR2_90:
        yes_or_no_mpool.append(1)
    else:
        yes_or_no_mpool.append(0)
print(yes_or_no_mpool)
print(len(yes_or_no_mpool))

m_pool_larger_90_index = []
for i, value in enumerate(yes_or_no_mpool):
    if value == 1:
        m_pool_larger_90_index.append(ltpFR2_index[i])
print("M pool larger 90 index", m_pool_larger_90_index)
print("Shape", np.shape(m_pool_larger_90_index))
