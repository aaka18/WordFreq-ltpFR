...
# Final Code For Word Recall Without Arousal
...
def calculate_params():
    ...
    for i in range(len(all_probs)):
        ...
        x_values = np.column_stack((all_concreteness_part, all_wordfreq_part, all_wordlen_part, all_valence_part_norm,
                                   all_imag_part_norm, all_m_list_part_norm, all_means_mpool_part_norm))
...
print(multipletests([t_test_concreteness[1], t_test_wordfreq[1], t_test_wordlen[1],
                     t_test_valence[1], t_test_imag[1],
...
predictors = ['Concreteness', 'Word Frequency', 'Word Length', 'Valence',
               'Imageability', 'List Meaningfulness', 'Pool Meaningfulness', ]
...
plt.savefig("Final_Word_Recall_NoArousalJan8_.pdf")
plt.show()
