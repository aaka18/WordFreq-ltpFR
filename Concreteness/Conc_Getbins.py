...
from Concreteness.Conc_Excel import bin_edges
...
def get_bins():
    ...
    print((bin(final_conc)).count(10))
    print((bin(final_conc)).count(11))
    print((bin(final_conc)).count(12))
    print((bin(final_conc)).count(13))
    # print((bin(final_conc)).count(14))
    # print((bin(final_conc)).count(15))
    # print((bin(final_conc)).count(16))
    # print((bin(final_conc)).count(17))
    # print((bin(final_conc)).count(18))
    # print((bin(final_conc)).count(19))
...
def pool_freq(concreteness, final_indexes):
    ...
    final_indexes_masked = ma.masked_invalid(concreteness)
    concreteness = concreteness_masked

    final_conc = []
    for i in range(len(final_indexes_masked)):
        final_conc.append(concreteness[i])
    #print(final_freq)
...
def bin(final_meaningfulness):
    ...
    for i in range(len(final_meaningfulness)):
        if final_meaningfulness[i] >= 0 and final_meaningfulness[i] <= bin_edges[0]:
            ...
            bins.append(12)
        elif final_meaningfulness[i] > bin_edges[12]:
            bins.append(13)
        # elif final_meaningfulness[i] > bin_edges[13]:
        #     bins.append(14)
        ...
        #     bins.append(18)
        # elif final_meaningfulness[i] > bin_edges[18]  and final_meaningfulness[i] <= 1 :
        #     bins.append(19)
    print(bins)
    print(len(bins))
    return(bins)
