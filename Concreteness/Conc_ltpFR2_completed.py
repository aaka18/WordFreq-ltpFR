...
from Concreteness.Conc_Excel import M
import scipy.io
...
if __name__ == "__main__":
    ...
    plt.suptitle('Word Concreteness', fontsize=20)
    plt.xlabel('Concreteness', fontsize=18)
    plt.ylabel('Recall Probability', fontsize=16)
    f_all_ltpFR2 = plt.errorbar(M, all_prob[0], yerr = sem_ltpFR_2[0])
    plt.ylim(.40, .65)
    plt.savefig("WordConcvsprec.Jan15.pdf")
    plt.show()
