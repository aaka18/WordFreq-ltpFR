import glob
from Valence.Valence_Getbins import get_bins
import numpy as np
import matplotlib.pyplot as plt
from Valence.Valence_Excel import M
import scipy.io
...
if __name__ == "__main__":
    ...
    plt.suptitle('Word Valence', fontsize=20)
    ...
    plt.ylim(.40, .65)
    plt.savefig("WordValencevsprec.Jan15.pdf")
    plt.show()
