import glob
from Meaningfulness.MPool.MPool_Getbins import get_bins
import numpy as np
import matplotlib.pyplot as plt
from Meaningfulness.MPool.MPool_Excel import M
import scipy.io
...
if __name__ == "__main__":
    ...
    plt.suptitle('Word Pool Meaningfulness', fontsize=20)
    ...
    plt.ylim(.40, .65)
    plt.savefig("MPoolvsprec.Jan15.pdf")
    plt.show()
