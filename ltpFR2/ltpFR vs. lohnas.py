# Run Mat Files to import f_task & F_no_task
# Run MatFiles_four to import f_task & f_no_task
...
files_lohnas = ['/Users/adaaka/rhino_mount/data/eeg/scalp/ltp/ltpFR/behavioral/data/stat_data_LTP065.mat',
    '/Users/adaaka/rhino_mount/data/eeg/scalp/ltp/ltpFR/behavioral/data/stat_data_LTP066.mat',
    '/Users/adaaka/rhino_mount/data/eeg/scalp/ltp/ltpFR/behavioral/data/stat_data_LTP067.mat',
    '/Users/adaaka/rhino_mount/data/eeg/scalp/ltp/ltpFR/behavioral/data/stat_data_LTP069.mat',
    '/Users/adaaka/rhino_mount/data/eeg/scalp/ltp/ltpFR/behavioral/data/stat_data_LTP070.mat',
...
all_prob_all = get_graphs(files_all)
all_prob_lohnas = get_graphs(files_lohnas)

plt.suptitle('Word Frequency Effect in ltpFR', fontsize=20)
plt.xlabel('Word Frequency', fontsize=18)
plt.ylabel('Recall Probability', fontsize=16)
f_no_task_all = plt.plot(M, all_prob_all[1], label='Updated No Task')
f_no_task_lohnas = plt.plot(M, all_prob_lohnas[1], label='Original No Task')
f_task_lohnas = plt.plot(M, all_prob_lohnas[0], label='Original Task')
f_task_all = plt.plot(M, all_prob_all[0], label='Updated Task')
plt.xscale('log')
plt.ylim((.50, .75))
plt.legend(loc='upper right', prop={'size':10.5}).draggable()
plt.show()
