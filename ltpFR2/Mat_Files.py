...
import scipy.io
from Excel import M
from pools import get_bins


# REPLICATION OF LOHNAS PAPER WITH ALL PARTICIPANTS
...
# files = glob.glob('/Users/adaaka/rhino_mount/data/eeg/scalp/ltp/ltpFR/behavioral/data/stat_data_LTP[0-9][0-9][0-9].mat')
files = ['/Users/adaaka/rhino_mount/data/eeg/scalp/ltp/ltpFR/behavioral/data/stat_data_LTP063.mat',
