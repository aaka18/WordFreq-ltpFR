...
def get_bins_ltpFR():
    ...
    # Finding the bin numbers associated with each frequency (after word freqs without concreteness or imaginability scores are eliminated)
...
def concreteness_index(a):
    ...
    # Function to find word frequencies that also have a concreteness score greater than 0.
    conc_index = []
...
def imaginability_index(a):
    ...
    # Function to find word frequencies that also have an imaginability score greater than 0.
    imag_index = []
    for index in range(len(a)):
        if a[index] > 0:
...
def pool_freq(word_freq, final_indexes):
    ...
    # Function to find the word frequencies when word index is given
...
def bin(final_freq):
    ...
    # for i in range(len(final_freq)):
    #     if final_freq[i] >= 0 and final_freq[i] <= 18:
    #         bins.append(0)
    #     elif final_freq[i] > 18 and final_freq[i] <= 37:
    #         bins.append(1)
    #     elif final_freq[i] > 37 and final_freq[i] <= 52:
    #         bins.append(2)
    #     elif final_freq[i] > 52 and final_freq[i] <= 85:
    #         bins.append(3)
    #     elif final_freq[i] > 85 and final_freq[i] <= 143:
    #         bins.append(4)
    #     elif final_freq[i] > 143 and final_freq[i] <= 204:
    #         bins.append(5)
    #     elif final_freq[i] > 204 and final_freq[i] <= 299:
    #         bins.append(6)
    #     elif final_freq[i] > 300 and final_freq[i] <= 536:
    #         bins.append(7)
    #     elif final_freq[i] > 536 and final_freq[i] <= 1219:
    #         bins.append(8)
    #     elif final_freq[i] > 1220 and final_freq[i] <= 13345:
    #         bins.append(9)
    print(bins)
    return(bins)
