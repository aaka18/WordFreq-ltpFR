...
def bin(final_freq):
    ...
    for i in range(len(final_freq)):
        if final_freq[i] >= 2 and final_freq[i] <= 87:
            bins.append(0)
        elif final_freq[i] > 87 and final_freq[i] <= 237:
            bins.append(1)
        elif final_freq[i] > 237 and final_freq[i] <= 617:
            bins.append(2)
        elif final_freq[i] > 617 and final_freq[i] <= 26215:
            bins.append(3)
    print(bins)
    return(bins)
