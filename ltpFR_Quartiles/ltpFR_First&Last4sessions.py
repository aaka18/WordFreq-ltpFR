...
def get_ltpFR(files_ltpFR):
    ...
    def quarts(probabilities):
        ...
        # P-rec of top quartile - middle two quartiles
    ...
    for f in files_ltpFR:
        ...
        for s in session_of_interest:
            ...
            #print("Single numbers", this_subj_single_numbers)
    ...
    print("All SEM:", all_subjects_nansem)
...
if __name__ == "__main__":
    ...
    all_subjects_nanmean, all_subjects_nansem =  get_ltpFR(files_ltpFR)
